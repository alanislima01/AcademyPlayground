...
public class FalandoComMonge: UIViewController{
    ...
    @IBAction func escolherOpcao(sender: UIButton){
        ...
        self.fraseExplicando.isHidden = true
    ...
    @IBAction func tocarBotaoVoltarTudo() {
        ...
        let novaViewController = buscandoMonge()
    ...
    override public func loadView(){
        ...
        botao1.titleLabel?.font = UIFont(name: "Nunito-Regular", size: 28)
        ...
        botao2.titleLabel?.font = UIFont(name: "Nunito-Regular", size: 28)
        ...
        botao3.titleLabel?.font = UIFont(name: "Nunito-Regular", size: 28)
        ...
        balaoMonge.frame = CGRect(x: 602, y: 80, width: 577, height: 196)
        ...
        falaMonge.frame = CGRect(x: 612, y: 78, width: 570, height: 180)
        falaMonge.isHidden = true
    ...
    func encerrar(){
        ...
        falaMonge.text = "Foi um prazer conhecer você, Boop. Qualquer coisa que precisar estarei aqui em cima meditanto...."
